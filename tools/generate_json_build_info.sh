...
output=$2/$1.json
version=./vendor/mist/config/version.mk
...
if [ -f $existingOTAjson ]; then
        ...
        type=`grep -n "ro.mist.buildtype" $defaultprop | cut -d':' -f1`
        ...
        "response": [
                {
                        ...
                        "version": "'$version'",
                        "filename": "'$filename'",
                        "download": "https://sourceforge.net/projects/project-mistos/files/Android-14/'$1'/'$buildtype'/'$3'/download",
                        "timestamp": '$timestamp',
                        "md5": "'$md5'",
                        "sha256": "'$sha256'",
                        "size": '$size',
