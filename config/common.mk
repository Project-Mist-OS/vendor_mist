# Branding
$(call inherit-product, vendor/mist/config/branding.mk)
...
PRODUCT_COPY_FILES += \
    vendor/mist/prebuilt/common/etc/init/init.pixelexperience-updater.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.pixelexperience-updater.rc
...
PRODUCT_COPY_FILES += \
    vendor/mist/config/permissions/android.software.nfc.beam.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/android.software.nfc.beam.xml
...
# Power whitelist
PRODUCT_COPY_FILES += \
    vendor/mist/config/permissions/custom-power-whitelist.xml:system/etc/sysconfig/custom-power-whitelist.xml
