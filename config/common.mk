...
# mist-specific broadcast actions whitelist
PRODUCT_COPY_FILES += \
    vendor/mist/config/permissions/mist-sysconfig.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/mist-sysconfig.xml
...
# Include Mist audio files
include vendor/mist/config/mist_audio.mk
