...
MIST_PLATFORM_VERSION := 14.0
MISTVERSION := 2.6

ifeq ($(MIST_VANILLA), true)
MIST_VERSION := Mist-OS-v$(MISTVERSION)-$(MIST_CODENAME)-$(MIST_BUILD_DATE)-$(MIST_BUILD)-$(MIST_BUILD_TYPE)-Vanilla
else
MIST_VERSION := Mist-OS-v$(MISTVERSION)-$(MIST_CODENAME)-$(MIST_BUILD_DATE)-$(MIST_BUILD)-$(MIST_BUILD_TYPE)-GApps
endif
