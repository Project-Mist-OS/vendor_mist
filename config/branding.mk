...
MIST_VERSION := MistOS-$(MIST_MOD_VERSION)-$(MIST_SUB_VERSION)-$(CURRENT_DEVICE)-$(MIST_EDITION)-$(MIST_BUILD_TYPE)-$(MIST_BUILD_DATE_UTC)
MIST_FINGERPRINT := MistOS/$(MIST_MOD_VERSION)/$(MIST_SUB_VERSION)/$(PLATFORM_VERSION)/$(MIST_BUILD_DATE_UTC)
MIST_DISPLAY_VERSION := MistOS-$(MIST_MOD_VERSION)-$(MIST_SUB_VERSION)-$(MIST_BUILD_TYPE)
else
MIST_VERSION := MistOS-$(MIST_MOD_VERSION)-$(MIST_SUB_VERSION)-$(CURRENT_DEVICE)-$(MIST_BUILD_TYPE)-$(MIST_BUILD_DATE_UTC)
MIST_FINGERPRINT := MistOS/$(MIST_MOD_VERSION)/$(MIST_SUB_VERSION)/$(PLATFORM_VERSION)/$(MIST_BUILD_DATE_UTC)
MIST_DISPLAY_VERSION := MistOS-$(MIST_MOD_VERSION)-$(MIST_SUB_VERSION)-$(MIST_BUILD_TYPE)
endif
